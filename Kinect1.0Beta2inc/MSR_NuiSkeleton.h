...
typedef struct _NUI_SKELETON_DATA
{
  ...
  DWORD dwUserIndex;
  Vector4 Position;
  Vector4 joints[NUI_JOINT_COUNT];
  NUI_SKELETON_POSITION_TRACKING_STATE jointsTrackingState[NUI_JOINT_COUNT];
